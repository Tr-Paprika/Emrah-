...
# ── Topbar: hem masaüstü hem mobil versiyonu ─────────────────────────────────
...
<!-- MOBİL TOP BAR — 2 satır, 4'lü ızgara -->
<div class='topbar-mobile' style='background:#0f172a;padding:10px 14px 6px;border-bottom:2px solid #1e3a5f;'>
  <!-- Logo satırı -->
  <div style='display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;'>
    ...
    <span style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#94a3b8;'>{saat_str}</span>
  </div>
  <!-- Satır 1: BIST100 + USD + GRAM + ONS -->
  <div style='display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:#1e3a5f;
              border-radius:8px;overflow:hidden;margin-bottom:1px;'>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>BIST</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{bist_s}</div>
      <div style='font-size:10px;'>{bist_chg_html}</div>
    </div>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>USD/TL</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{usd_s}</div>
    </div>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>GRAM ₺</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{gram_s}</div>
    </div>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>ONS $</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{ons_s}</div>
    </div>
  </div>
  <!-- Satır 2: BTC + EUR + BRENT + TCMB -->
  <div style='display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:#1e3a5f;
              border-radius:8px;overflow:hidden;margin-bottom:6px;'>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>BTC</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{btc_s}</div>
      <div style='font-size:10px;'>{btc_chg_html}</div>
    </div>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>EUR/TL</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{eur_s}</div>
    </div>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>BRENT</div>
      <div style='font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:700;color:#e2e8f0;'>{brent_s}</div>
    </div>
    <div style='background:#0d1b2e;padding:7px 8px;'>
      <div style='font-size:9px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;'>TCMB</div>
...
<div class='topbar'>
  <div class='t-logo'>
    ...
    <span class='t-badge'>Finans Analiz v6 · RT</span>
  </div>
  <div class='t-strip'>
    <div class='t-item'><span class='t-lbl'>BIST 100</span>
